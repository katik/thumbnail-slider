...
exports.default = {
	...
	mounted: function mounted() {
		console.log(233);
		var wrapper = $('.tn-transform-wrapper')[0];
		Transform(wrapper);
	...
	methods: {
		...
		_slideToItem: function _slideToItem(item) {
			var offset = .5 * this.fullLength - .5 * this.fullLength / this.count - item.offsetTop;
		...
		_slideBy: function _slideBy(offset) {
			...
			if (this.animation == 'ease') {
				...
				new this._animate(this.$transformWrapper, 'translateY', offset, 0, null, null);
			}
		},
