...
exports.default = {
	...
	mounted: function mounted() {
		...
		this.fullLength = this.direction == 'column' ? this.$el.getElementsByClassName('tn-transform-container')[0].clientHeight : this.$el.getElementsByClassName('tn-transform-container')[0].clientWidth;
		...
		Array.prototype.map.call(els, function (el) {
			_this.direction == 'column' ? el.style.height = elLength + 'px' : el.style.width = elLength + 'px';
		});
	...
	methods: {
		clickItem: function clickItem(el) {
		...
		_slideToItem: function _slideToItem(item) {
		...
		_slideBy: function _slideBy(offset) {
			var size = this.$el.getElementsByClassName('tn-transform-wrapper')[0][this.directionAtrMap.size[this.direction]];
