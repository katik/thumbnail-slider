...
exports.default = {
	...
	methods: {
		clickHandler: function clickHandler() {
			this.$parent && this.$parent.slideToItem(this);
		}
	}
...
exports.default = {
	...
	mounted: function mounted() {
		...
		$(this.$el).find(".tn-item").css('height', ($(this.$el).height() - $('.tn-next').height() - $('.tn-prev').height()) / this.count);
	},


	methods: {
		slideToItem: function slideToItem(item) {
			console.log(item.$el, 2);
			new this._animate(this.$transformWrapper, 'translateY', -100, 500, this._ease, null);
		},
